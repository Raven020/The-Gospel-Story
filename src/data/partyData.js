...
export const ROSTER = {
  ...
  jesus: {
    ...
    role: 'leader',
    sprite: 'jesus',
    baseStats: { hp: 200, sp: 100, str: 40, def: 30, wis: 60, fai: 99, spd: 35 },
    growth: { hp: 12, sp: 8, str: 3, def: 2, wis: 5, fai: 5, spd: 3 },
  ...
  peter: {
    ...
    role: 'tank',
    sprite: 'peter',
    baseStats: { hp: 180, sp: 60, str: 50, def: 40, wis: 25, fai: 40, spd: 30 },
    growth: { hp: 14, sp: 5, str: 5, def: 3, wis: 2, fai: 3, spd: 2 },
  ...
  james: {
    ...
    role: 'offense',
    sprite: 'james',
    baseStats: { hp: 160, sp: 70, str: 55, def: 18, wis: 20, fai: 35, spd: 38 },
    growth: { hp: 12, sp: 6, str: 5, def: 1, wis: 2, fai: 3, spd: 3 },
  ...
  john: {
    ...
    role: 'healer',
    sprite: 'john',
    baseStats: { hp: 130, sp: 90, str: 20, def: 15, wis: 50, fai: 55, spd: 28 },
    growth: { hp: 9, sp: 8, str: 1, def: 1, wis: 5, fai: 5, spd: 2 },
  ...
  philip: {
    ...
    role: 'analyst',
    sprite: 'philip',
    baseStats: { hp: 135, sp: 75, str: 28, def: 20, wis: 45, fai: 40, spd: 35 },
    growth: { hp: 10, sp: 7, str: 2, def: 2, wis: 4, fai: 3, spd: 3 },
  ...
  nathanael: {
    ...
    role: 'cleanser',
    sprite: 'nathanael',
    baseStats: { hp: 145, sp: 85, str: 25, def: 22, wis: 40, fai: 50, spd: 30 },
    growth: { hp: 11, sp: 7, str: 2, def: 2, wis: 4, fai: 4, spd: 2 },
  ...
  matthew: {
    ...
    role: 'resource',
    sprite: 'matthew',
    baseStats: { hp: 140, sp: 70, str: 25, def: 18, wis: 40, fai: 35, spd: 33 },
    growth: { hp: 10, sp: 6, str: 2, def: 2, wis: 4, fai: 3, spd: 3 },
  ...
  thomas: {
    ...
    role: 'detection',
    sprite: 'thomas',
    baseStats: { hp: 140, sp: 75, str: 30, def: 20, wis: 45, fai: 30, spd: 34 },
    growth: { hp: 10, sp: 7, str: 2, def: 2, wis: 4, fai: 2, spd: 3 },
  ...
  james_alphaeus: {
    ...
    baseStats: { hp: 150, sp: 70, str: 35, def: 25, wis: 35, fai: 35, spd: 32 },
    growth: { hp: 11, sp: 6, str: 3, def: 2, wis: 3, fai: 3, spd: 3 },
    abilities: [],
  },
  thaddaeus: {
    id: 'thaddaeus',
    ...
    role: 'tbd',
    sprite: 'thaddaeus',
    baseStats: { hp: 150, sp: 70, str: 35, def: 24, wis: 35, fai: 35, spd: 32 },
    growth: { hp: 11, sp: 6, str: 3, def: 2, wis: 3, fai: 3, spd: 3 },
    abilities: [],
  },
  simon_zealot: {
    ...
    role: 'tbd',
    sprite: 'simon_zealot',
    baseStats: { hp: 155, sp: 65, str: 40, def: 23, wis: 30, fai: 35, spd: 36 },
    growth: { hp: 12, sp: 5, str: 4, def: 2, wis: 2, fai: 3, spd: 3 },
    abilities: [],
  },
  judas: {
    id: 'judas',
    ...
    role: 'betrayer',
    sprite: 'judas',
    baseStats: { hp: 145, sp: 70, str: 35, def: 20, wis: 38, fai: 20, spd: 38 },
    growth: { hp: 10, sp: 6, str: 3, def: 2, wis: 3, fai: 1, spd: 4 },
...
export function createMember(rosterId, level = 1) {
  ...
  return {
    ...
    morale: 100, // 0-100 scale: affects combat effectiveness via getMoraleModifier()
  };
}
